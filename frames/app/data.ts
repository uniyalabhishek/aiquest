export const createPrompt = (difficulty: number) => {
  return `
## Your role
...
In This TPRG, player is in dungeon, there are 10 enemies, and player needs to defeat those enemies to clear the dungeon.
...
- Abyssal Hounds: These demonic beasts are vulnerable to silver and holy objects. They are also bound to their demonic alpha; defeating or banishing the alpha can scatter the pack and send them fleeing back to their hellish realms.
